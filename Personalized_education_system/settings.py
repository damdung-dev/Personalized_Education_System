"""
Django settings for Personalized_education_system project.
...
ALLOWED_HOSTS = [
    '127.0.0.1',
    'localhost',
    'a851e8e0baac.ngrok-free.app',  # host ngrok hiện tại
]

CSRF_TRUSTED_ORIGINS = [
    'https://a851e8e0baac.ngrok-free.app',
]

LOGIN_URL = ''          # URL của trang login của bạn
LOGIN_REDIRECT_URL = ''  # URL sau khi login thành công
...
# Thư mục chứa file tĩnh đã được collect
...
EMAIL_HOST_PASSWORD = '...'  # App Password nếu dùng Gmail
